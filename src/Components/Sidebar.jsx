...
function SideBar() {
  ...
  const [offeringType, setOfferingType] = useState("common");
  ...
  const handleOfferingClick = (type) => {
    setOfferingType(type);
    setShowDropdown(false);
    // Navigate to the correct offering page based on the type
    navigate(`/admin/offerings/${type}`);
  };
          ...
          <ul className="space-y-5 font-medium">
            ...
            <li>
              <Link
                ...
                className={`${
                  location.pathname.includes("/pastor") &&
                  !location.pathname.includes("/family")
                    ? "bg-lavender--600 text-white hover:text-lavender--600 hover:bg-slate-100"
                    : "text-gray-800 hover:bg-slate-100 hover:text-lavender--600"
                } flex items-center px-10 py-3 rounded-e-lg group`}
              >
                <img
                  ...
                  alt=""
                />
                <span className="text-lg ms-5">Pastor</span>
              </Link>
            </li>
                  ...
                  <Link
                    ...
                    className={`${
                      ...
                      (location.pathname.includes("type") &&
                        !location.pathname.includes("bagtype"))
                        ? "bg-lavender--600 text-white hover:text-lavender--600 hover:bg-slate-100"
                        : "text-gray-800 hover:bg-slate-100 hover:text-lavender--600"
                    } block px-6 py-2 text-gray-800 rounded-lg hover:bg-slate-100 hover:text-lavender--600`}
                  >
                    <span className="text-md ">Common Offerings</span>
                  </Link>

                  <Link
                    to="/admin/offerings/list/MarriageOfferings"
                    className={`${
                      location.pathname.includes("/MarriageOfferings") &&
                      !location.pathname.includes("/offerings/type")
                        ? "bg-lavender--600 text-white hover:text-lavender--600 hover:bg-slate-100"
                        : "text-gray-800 hover:bg-slate-100 hover:text-lavender--600"
                    } block px-6 py-2 text-gray-800 rounded-lg hover:bg-slate-100 hover:text-lavender--600`}
                  >
                    <span className="text-md ">Marriage Offerings</span>
                  </Link>
                  <Link
                    to="/admin/offerings/bagtype"
                    className={`${
                      location.pathname.includes("/bagtype") ||
                      location.pathname.includes("/BagOffer")
                        ? "bg-lavender--600 text-white hover:text-lavender--600 hover:bg-slate-100"
                        : "text-gray-800 hover:bg-slate-100 hover:text-lavender--600"
                    } block px-6 py-2 text-gray-800 rounded-lg hover:bg-slate-100 hover:text-lavender--600`}
                  >
                    <span className="text-md ">Bag Offerings</span>
                  </Link>
                </div>
              )}
            </li>
